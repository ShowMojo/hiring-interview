...
Transaction.create!([
                      { first_name: 'Steren', last_name: 'Nausikaa', from_currency: 'USD',
                        to_currency: 'CAD', from_amount_cents: 200_000, manager: managers[5] },
                      { first_name: 'Muthoni', last_name: 'Iunia', from_currency: 'USD',
                        to_currency: 'GBP', from_amount_cents: 300_000, manager: managers[8] },
                      { first_name: 'Anna', last_name: 'Bogali', from_currency: 'USD',
                        to_currency: 'GBP', from_amount_cents: 11_000, manager: managers[8] },
